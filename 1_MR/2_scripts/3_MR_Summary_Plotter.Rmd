...
summary_plotter <- function(input_tb, label_tb, method_choice = 'Inverse variance weighted|Wald ratio', output_folder = '1_MR/3_output/3_summary_plots/', conf_int=T, point_size= 3){
  ...
  ggsave(str_c(output_folder,'/MR_summary_plot.png'),summary_scatter, dpi=600, width=10, height=7.5)
  ...
  if(isTRUE(conf_int)){
    ...
    ggsave(str_c(output_folder,'/MR_summary_plot_confint.png'),summary_scatter_confint, dpi=600, width=10, height=7.5)
  }
...
ggsave('1_MR/3_output/3_summary_plots/sig_MR_forestplot_combined_noHF.png',combined_forest_plot, dpi=600, width=6, height=4)
