...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot.png',forest_plot_overall, dpi=600, width=9, height=6)
```

I also plot the forest plot broken down into 2 plots instead and where HCM = exposure, do per doubling odds(HCM) and where it is outcome, do OR(HCM).

```{r}
forest_plot_hcmexposure <- ggplot(filter(sig_mr_results_or, str_detect(exposure, 'HCM')))+
  geom_point(aes(x=b*log(2), y= exposure_outcome))+
  geom_errorbar(aes(xmin=lo_ci*log(2), xmax=up_ci*log(2), y=exposure_outcome))+
  geom_vline(xintercept=0, col='black', linetype='dashed')+
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_hcmexposure.png',forest_plot_hcmexposure, dpi=600, width=6, height=3)

forest_plot_hcmoutcome <- ggplot(filter(sig_mr_results_or, str_detect(outcome, 'HCM')))+
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_hcmoutcome.png',forest_plot_hcmoutcome, dpi=600, width=6, height=3)

combined_forest_plot <- forest_plot_hcmexposure / forest_plot_hcmoutcome
print(combined_forest_plot)
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_combined.png',combined_forest_plot, dpi=600, width=9, height=6)
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_subgroup_hcmexposure.png',forest_plot_subgroup_hcm_exposure, dpi=600, width=6, height=3)
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_subgroup_hcmoutcome.png',forest_plot_subgroup_hcm_outcome, dpi=600, width=6, height=3)
```
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_subgroup_hcmexposure_doubleOdds.png',forest_plot_subgroup_hcm_exposure_doubleOdds, dpi=600, width=6, height=3)
...
ggsave('../3_output/3_summary_plots/sig_MR_forestplot_subgroup_hcmoutcome_OR.png',forest_plot_subgroup_hcm_outcome_OR, dpi=600, width=6, height=3)
```
