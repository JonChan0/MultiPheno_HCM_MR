...
```{r}
#This is the number of MTC-passed sig. traits from PheWAS of 10k randomly sampled SNPs from OTG.
nulldist <- read_rds('../1_data/pleiotropy_threshold/nulldist_10k.rds')
