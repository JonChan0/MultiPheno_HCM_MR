...
```{r}
pwalk(instrument_files, phenotypes, redflags,~snp_pleio_filter(..1,..2,'../3_output/1_MR_QC/pleiotropy_check/',..3))

#For HCM <-> AF
# snp_pleio_filter('../1_data/gwas_associations/roselli25_af_associations.xlsx','AF','../3_output/1_MR_QC/pleiotropy_check/',hcm_outcome_redflags)
```
